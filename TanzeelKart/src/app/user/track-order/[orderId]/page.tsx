          ...
          <div className='bg-white rounded-3xl shadow-lg border p-4 h-[430px] flex flex-col'>
            ...
            <div className='flex justify-between items-center mb-3'>
              ...
              <motion.button
                disabled={loading}
                whileTap={{ scale: 0.9 }}
                className="px-3 py-1 text-xs flex items-center gap-1 bg-purple-100 text-purple-700 rounded-full border"
            ...
            <div className='flex gap-2 flex-wrap mb-3'>
              {suggestions.map((s, i) => (
                <motion.div
                  key={i}
                  whileTap={{ scale: 0.92 }}
                  className="px-3 py-1 text-xs bg-green-50 border cursor-pointer text-green-700 rounded-full"
            ...
            <div className='flex gap-2 mt-3 border-t pt-3'>
              ...
              <button className='bg-green-600 p-3 rounded-xl text-white' onClick={sendMsg}>
                <Send size={18} />
              </button>
            </div>
